...
export const metadata = {
  title: "About Us | Young Wheels - Kids Ride On Toys Manufacturer",
  description:
    "Learn about Young Wheels, India's trusted manufacturer of safe, durable and creative ride-on toys, swing cars, potty trainers and rocking animals for kids.",
  keywords: [
    "about Young Wheels",
    "kids toys manufacturer India",
    "ride on toys company Delhi",
    "swing car manufacturer",
  ],
  alternates: {
    canonical: "/about-us",
  },
